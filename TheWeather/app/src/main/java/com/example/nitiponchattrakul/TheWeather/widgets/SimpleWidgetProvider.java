package com.example.nitiponchattrakul.TheWeather.widgets;
...
import com.example.nitiponchattrakul.TheWeather.BuildConfig;
import com.example.nitiponchattrakul.TheWeather.activities.MainActivity;
...
public class SimpleWidgetProvider extends AbstractWidgetProvider {
    ...
    private static final String ACTION_UPDATE_TIME = "com.example.nitiponchattrakul.forecastie.UPDATE_TIME";
