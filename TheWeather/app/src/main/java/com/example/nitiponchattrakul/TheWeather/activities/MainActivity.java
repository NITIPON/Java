package com.example.nitiponchattrakul.TheWeather.activities;
...
import com.example.nitiponchattrakul.TheWeather.AlarmReceiver;
import com.example.nitiponchattrakul.TheWeather.Constants;
import com.example.nitiponchattrakul.TheWeather.R;
import com.example.nitiponchattrakul.TheWeather.adapters.ViewPagerAdapter;
import com.example.nitiponchattrakul.TheWeather.adapters.WeatherRecyclerAdapter;
import com.example.nitiponchattrakul.TheWeather.fragments.RecyclerViewFragment;
import com.example.nitiponchattrakul.TheWeather.models.Weather;
import com.example.nitiponchattrakul.TheWeather.tasks.GenericRequestTask;
import com.example.nitiponchattrakul.TheWeather.tasks.ParseResult;
import com.example.nitiponchattrakul.TheWeather.tasks.TaskOutput;
import com.example.nitiponchattrakul.TheWeather.utils.UnitConvertor;
import com.example.nitiponchattrakul.TheWeather.widgets.AbstractWidgetProvider;
import com.example.nitiponchattrakul.TheWeather.widgets.DashClockWeatherExtension;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
    ...
    private void aboutDialog() {
        AlertDialog.Builder alert = new AlertDialog.Builder(this);
        alert.setTitle("The Weather");
        final WebView webView = new WebView(this);
        String about = "<p>Weather report & forcasting application</p>"+
                "<p>By Nitipon & Possatorn</p>"+
                "<p>Data provided by <a href='https://openweathermap.org/'>OpenWeatherMap</a>" +
                "<p>Icons are <a href='https://erikflowers.github.io/weather-icons/'>Weather Icons</a>, by <a href='http://www.twitter.com/artill'>Lukas Bischoff</a> and <a href='http://www.twitter.com/Erik_UX'>Erik Flowers</a>";
