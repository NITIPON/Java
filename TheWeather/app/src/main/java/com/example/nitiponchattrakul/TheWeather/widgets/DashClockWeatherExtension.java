...
import com.example.nitiponchattrakul.TheWeather.activities.SplashActivity;
...
public class DashClockWeatherExtension extends DashClockExtension {
    private static final Uri URI_BASE = Uri.parse("content://com.example.nitiponchattrakul.forecastie.authority");
